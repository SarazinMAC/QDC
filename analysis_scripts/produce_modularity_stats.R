##############################################
##### Produce Modularity Stats and Graph #####
##############################################
...
vis <- ggplot(data = all_community_stats_combined_df[c(-1, -2),],
...
jpeg(filename = paste0(export_path, "charts\\Network_modularity_", text_or_pers, "_network_", cd_algorithm, "_no_loops.jpeg"),
